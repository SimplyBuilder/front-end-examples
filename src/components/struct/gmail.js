...
const getJSON = async () => {
    const requestJson = await fetch("./assets/gmail/struct.json", {
        method: "GET",
        headers: {
            Accept: "text/plain",
...
const getCSS = async () => {
    const requestJson = await fetch("./assets/gmail/styles.css", {
        method: "GET",
        headers: {
            Accept: "text/plain",
            "Cache-Control": "no-cache",
...
export const gmailStruct = Object.freeze(getStruct);